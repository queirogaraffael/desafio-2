...
public class ConstantesMenuPrincipal {
	...
	public static final String VISUALIZA_ID_TITULO_DATA_STATUS = "Visualizar resumo tarefas";
	public static final String VISUALIZAR_TAREFA_ID = "Retornar tarefa pelo ID";
